...
import com.toucheese.reservation.repository.ReservationQueryRepository;
...
public class ReservationQueryService {
	...
	public Page<Reservation> findReservationsByStatusAndDate(ReservationStatus status, LocalDate createDate,
		Pageable pageable) {
		return reservationQueryRepository.findReservations(status, createDate, pageable);
	}
	...
	public Page<ReservationResponse> findPagedReservationsByMemberId(Long memberId, int page) {
		...
		return reservationQueryRepository.findPagedReservationsByMemberId(memberId, pageable)
	...
	public Reservation findReservationByIdAndMemberId(Long reservationId, Long memberId) {
		return reservationQueryRepository.findByIdAndMemberId(reservationId, memberId)
